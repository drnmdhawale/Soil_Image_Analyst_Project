 ...
 */
FARPROC WINAPI folder_analyseDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = folder_analyseDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = folder_analyseDelayLoadWin32FailureHook;
#endif
